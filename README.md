...
Bridging molecular geometry with qualitative chemical intuition. **Valence** is a single page web application designed to algorithmically determine and visualize valence bond orbitals (hybridization, localized lone pairs, and orbital overlap lobes) typically taught in undergraduate general and organic chemistry courses.
