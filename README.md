...
*   **💎 Four Atom Looks:** The Style tab styles atoms and orbitals independently. Atoms offer Classic (the original shading), Soft (studio image lighting, no lamps), Glossy (clearcoat ceramic), and Showcase (key/rim/fill rig, brightest); orbitals keep their own Glass / Glossy / Matte / Metal presets.
