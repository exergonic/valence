...
| `src/render/` | Core Three.js logic: atoms, bonds, lighting, orbital lobes (`lobes.ts` LatheGeometry profiles), `rebuild.ts` state-driven rebuild, `label-colors.ts` (background-aware label palettes). |
